    ...
    return (
        <Card ref={ref} className={cn("group overflow-hidden border-none py-0 transition-all", className)} onClick={() => open({ type: type, id: id })}>
            <CardContent className="p-0">
                <div className={cn("relative overflow-hidden rounded-md bg-muted w-full", aspectRatio === "portrait" ? "" : "aspect-video")} style={aspectRatio === "portrait" ? { aspectRatio: "2 / 3" } : undefined}>
                    <img
