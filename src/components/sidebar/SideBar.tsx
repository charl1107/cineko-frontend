...
import { LucideCog, LucideFilm, LucideHome, LucideTv, Sparkles } from "lucide-react"
...
export default function SideBar() {
    ...
    return (
        <Sidebar side="left" variant="floating" collapsible="offcanvas" className={"z-[60]" + (isVisible ? " hidden" : "")}>
            {/* Header */}
            <SidebarHeader>
                ...
                <SidebarGroup>
                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            ...
                            <SidebarMenuItem>
                                <Button variant={"link"} onClick={() => clickHandler("/anime")} className={navItemClass(isActive("/anime"))}>
                                    <Sparkles size={18} />
                                    <span>{t("anime.plural")}</span>
                                </Button>
                            </SidebarMenuItem>
                        </SidebarMenu>
                    </SidebarGroupContent>
